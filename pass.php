...
<body>
	<div class="main">
		...
		<div class="site_content">
			...
			<div class="reg-form">
				<h1 style = "color: #ca7272; font-weight: bold; margin: 0 0 15px 0">Восстановление пароля</h1>
				<form method = "post" action = "find_pass.php">
					<input type = "text" name = "search_log" placeholder = "Ваш логин">
					<input type = "text" name = "search_name" placeholder = "Ваше имя">
					<input type = "submit" class = "send-button" value = "Вывести пароль" style = "margin-right: 40px">
				</form>
			</div>
		</div>
		<div class="footer">
