			...
			<div class="send">
				<form method = "post" action = "send_message.php">
					<?php if(isset($_COOKIE['error_email'])): ?>
						<input type = "text" name = "from" placeholder = "Ваш e-mail">
						<div class="error-contacts"><?=$_COOKIE['error_email']?></div>
						<input type = "text" name = "subject" placeholder = "Тема сообщения">
						<textarea name = "message" placeholder = "Сообщение"></textarea><br>
						<button type = "submit" class = "send-button">Отправить</button>
					<?php elseif(isset($_COOKIE['error_subject'])):?>
						<input type = "text" name = "from" placeholder = "Ваш e-mail">
						<input type = "text" name = "subject" placeholder = "Тема сообщения">
						<div class="error-contacts"><?=$_COOKIE['error_subject']?></div>
						<textarea name = "message" placeholder = "Сообщение"></textarea><br>
						<button type = "submit" class = "send-button">Отправить</button>
					<?php elseif(isset($_COOKIE['error_message'])):?>
						<input type = "text" name = "from" placeholder = "Ваш e-mail">
						<input type = "text" name = "subject" placeholder = "Тема сообщения">
						<textarea name = "message" placeholder = "Сообщение"></textarea><br>
						<div class="error-contacts"><?=$_COOKIE['error_message']?></div>
						<button type = "submit" class = "send-button">Отправить</button>
					<?php else:?>
						<input type = "text" name = "from" placeholder = "Ваш e-mail">
						<input type = "text" name = "subject" placeholder = "Тема сообщения">
				...
				<div class="social-networks">
					<a href = " https://wa.me/+77029800147"><img src="img/whatsapp3.png" alt="Взлом жепы"></a>
					<a href = "tel:+77029800147"><img src="img/telephone1.png" alt="Взлом жепы"></a>
				</div>
			</div>
		</div>
		<div class="footer">
