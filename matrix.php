		...
		<div class="site_content">
			...
			<div class="content">
				...
				<div class="film-description">
					<p><span class="label">Фильм: </span><span class = "value-info">Матрица</span><span class = "label">Год: </span><span class = "value-info">1999</span><span class="label">Режиссер: </span><span class="value-info">Лана/Лилли Вачовские</span></p>
				</div>
				<div class="film-info">
					<hr>
					<h1>Описание фильма "Матрица"</h1>
				...
				<div class="movie">
					<video width="100%" autoplay="autoplay" controls>
						<source src="films/matrix.mp4" type="video/mp4">
					</video>
				</div>
				<hr>
				<h1>Отзывы "Матрица"</h1>
				<div class="reviews">
					<?php 
					if(isset($_POST['comment-name'])): 
						...
						$mysql -> query('set character_set_server=utf8');
						$mysql ->  query("SET SESSION collation_connection = 'utf8_general_ci';");
						$mysql -> query("INSERT INTO `matrix` (`comment_name`, `comment_text`, `date`) VALUES('$comment_name', '$comment_text', '$date')");
						$comments = $mysql -> query("SELECT * FROM `matrix`");
