...
<body>
	<div class="main">
		...
		<div class="site_content">
			...
			<div class="content">
				<h1>Трейлер фильма "Невидимый гость"</h1>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/CfmK-lX7nXo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div class="film-description">
					<p><span class="label">Фильм: </span><span class = "value-info">Невидимый гость</span><span class = "label">Год: </span><span class = "value-info">2018</span><span class="label">Режиссер: </span><span class="value-info">Ориол Паоло</span></p>
				</div>
				<div class="film-info">
					<hr>
					<h1>Описание фильма "Невидимый гость"</h1>
					<img src="img/invisible-guest.jpg" alt="Взлом жепы" style = "margin-bottom: 15px">
				...
				<div class="movie">
					<video width="100%" autoplay="autoplay" controls>
						<source src="films/Invisible-guest.mp4" type="video/mp4">
					</video>
				</div>
				<hr>
				<h1>Отзывы "Невидимый гость"</h1>
				<div class="reviews">
					<?php 
					if(isset($_POST['comment-name'])): 
						...
						$mysql -> query('set character_set_server=utf8');
						$mysql ->  query("SET SESSION collation_connection = 'utf8_general_ci';");
						$mysql -> query("INSERT INTO `invisible_guest` (`comment_name`, `comment_text`, `date`) VALUES('$comment_name', '$comment_text', '$date')");
						$comments = $mysql -> query("SELECT * FROM `invisible_guest`");
