	...
	<div class="main">
		<div class="header">
			...
			<div class="menubar">
				<ul class="menu">
					...
					<li class = "selected"><a href = "private.php">Кабинет[<?=$_COOKIE['name']?>]</a></li>
					<?php else:?>
					<li class = "selected"><a href = "private.php">Кабинет</a></li>
					<?php endif; ?>
				</ul>
			</div>
		</div>
		<div class="site_content">
			...
			<div class="content">
				<?php if (!isset(($_COOKIE['login']))):?>
				<div class="card">
					<a href = "private.php"><img src="img/unavailable.png" alt="Взлом жепы" class="card-unavailable" style = "border-radius: none; border: none"></a>
					<h1 style = "color: red; text-align: center">Кабинет недоступен</h1>
					<div id = "unavailable">
						<span>Чтобы открыть <a href="private.php">кабинет</a> вам нужно <a href="registration.php">зарегистрироваться</a> или <a href="authorization.php">авторизоваться</a></span>
					</div>
				</div>
				<?php else:?>
				<div class="card">
					<img src="img/user.png" alt="Взлом жепы" class="card-photo">
					<h1 class="card-name"><?=$_COOKIE['name']?></h1>
					<p class = "card-text">Просмотрено фильмов: 0</p>
					<p class = "card-text">Оставлено отзывов: 0</p>
				</div>
				<div class="logout">
