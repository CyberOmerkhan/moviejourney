...
<body>
	<div class="main">
		...
		<div class="site_content">
			...
			<div class="reg-form">
				<?php if(!isset($_COOKIE['login'])): ?>
				<h1 style = "color: #ca7272; font-weight: bold; margin: 0 0 15px 0">Регистрация</h1>
				<form method = "post" action = "check_registration.php">
					<?php if(isset($_COOKIE['error_name'])): ?>
						<input type = "text" name = "name" placeholder = "Введите имя">
						<div class="error"><?=$_COOKIE['error_name']?></div>
						<input type = "text" name = "login" placeholder = "Ваш логин">
						<input type = "password" name = "pass" placeholder = "Ваш пароль">
						<input type = "submit" class = "send-button" value = "Зарегистрироваться" style = "margin-right: 60px">
					<?php elseif(isset($_COOKIE['error_login'])):?>
						<input type = "text" name = "name" placeholder = "Введите имя">
						<input type = "text" name = "login" placeholder = "Ваш логин">
						<div class="error"><?=$_COOKIE['error_login']?></div>
						<input type = "password" name = "pass" placeholder = "Ваш пароль">
						<input type = "submit" class = "send-button" value = "Зарегистрироваться" style = "margin-right: 60px">
					<?php elseif(isset($_COOKIE['error_pass'])):?>
						<input type = "text" name = "name" placeholder = "Введите имя">
						<input type = "text" name = "login" placeholder = "Ваш логин">
						<input type = "password" name = "pass" placeholder = "Ваш пароль">
						<div class="error"><?=$_COOKIE['error_pass']?></div>
						<input type = "submit" class = "send-button" value = "Зарегистрироваться" style = "margin-right: 60px">
					<?php else: ?>
						<input type = "text" name = "name" placeholder = "Введите имя">						
						<input type = "text" name = "login" placeholder = "Ваш логин">
				...
				<?php else:?>
				<h1 style = "color: #ca7272; font-weight: bold; margin: 0 0 15px 0">Вы уже зарегистрированы и авторизованы</h1>
				<?php endif;?>
			</div>
		</div>
		<div class="footer">
