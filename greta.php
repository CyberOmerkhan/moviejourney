...
<body>
	<div class="main">
		...
		<div class="site_content">
			...
			<div class="content">
				<h1>Трейлер фильм "В объятиях лжи"</h1>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/Q7E_p-shB3c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div class="film-description">
					<p><span class="label">Фильм: </span><span class = "value-info">В объятиях лжи</span><span class = "label">Год: </span><span class = "value-info">2018</span><span class="label">Режиссер: </span><span class="value-info">Нил Джордан</span></p>
				</div>
				<div class="film-info">
					<hr>
					<h1>Описание фильма "В объятиях лжи"</h1>
					<img src="img/greta.jpg" alt="Взлом жепы" style = "margin-bottom: 15px">
					Фильм изображает симпатичную и одинокую девушку по имени Фрэнсис Маккален. Девушка, недавно переехавшая на Манхэттен, случайно встречается с такой же одинокой и загадочной вдовой. Между ними завязывается дружба, и необычная знакомая окружает юную подругу вниманием и заботой. Но вскоре одна из них поймет, что оказалась в крепких объятиях лжи…
				</div>
				<hr style = "margin-top: 30px">
				<div class="movie">
					<video width="100%" autoplay="autoplay" controls>
						<source src="films/Greta.mp4" type="video/mp4">
					</video>
				</div>
				<hr>
				<h1>Отзывы "В объятиях лжи"</h1>
				<div class="reviews">
					<?php 
					if(isset($_POST['comment-name'])): 
						...
						$mysql -> query('set character_set_server=utf8');
						$mysql ->  query("SET SESSION collation_connection = 'utf8_general_ci';");
						$mysql -> query("INSERT INTO `greta` (`comment_name`, `comment_text`, `date`) VALUES('$comment_name', '$comment_text', '$date')");
						$comments = $mysql -> query("SELECT * FROM `greta`");
